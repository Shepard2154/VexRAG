...
class TestAttackMethodRegistry:
    def test_registry_unknown_get_raises(self) -> None:
    ...
    def test_registry_default_adv_per_query_from_plugins(self) -> None:
    ...
    def test_default_adv_per_query_usecase(self) -> None:
