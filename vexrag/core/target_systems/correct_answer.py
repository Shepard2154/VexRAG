...
from vexrag.core.target_systems.types import TargetSystemQuery


class TargetCorrectAnswerProvider:
    """Fetches correct answers from the configured target RAG."""

    __slots__ = ("target_system", "attack")

    def __init__(self, target_system: TargetSystemAdapter, attack: str) -> None:
